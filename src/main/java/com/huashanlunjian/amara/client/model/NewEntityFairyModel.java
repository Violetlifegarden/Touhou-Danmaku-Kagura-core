package com.huashanlunjian.amara.client.model;
...
public class NewEntityFairyModel extends EntityModel<Boss> {
    public static ModelLayerLocation LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Amara.MOD_ID, "main"), "new_fairy");
    ...
    @Override
    public void setupAnim(Boss entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
